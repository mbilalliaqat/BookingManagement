...
import Refunded_Form from './Refunded_Form';
...
const Refunded = () => {
    ...
    const handleDelete = async (id) => {
        console.log('Attempting to delete refunded entry with id:', id);
        setIsDeleting(true);
        ...
        if (!parsedId || isNaN(parsedId) || typeof parsedId !== 'number') {
            ...
            setError('Invalid refunded ID. Cannot delete.');
            setIsDeleting(false);
            return;
        }
        try {
            ...
            console.error('Error deleting refunded entry:', error);
            setError('Failed to delete refunded entry. Please try again later.');
        } finally {
            setIsDeleting(false);
            closeDeleteModal();
        }
